...
describe('jazz_deployments', function () {
  ...
  it("should indicate error if deployment_id is unavailable for GET, PUT and DELETE requests", () => {
    errType = "BadRequest";
  ...
  it("should indicate error if update data is not unavailable for PUT request", () => {
    errType = "BadRequest";
  ...
  it("should indicate error if create payload is unavailable for POST request", () => {
    errType = "BadRequest";
  ...
  it("should indicate error if deployment_id is unavailable for POST request with re-build path", () => {
    errType = "BadRequest";
