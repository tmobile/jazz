...
var elfContentLog = context.getVariable("elfLog.proxyResponseContent");

//set to update the payload from out of sharedflow
if (typeof elfContentLog !== 'undefined' && elfContentLog !== null) {
	context.setVariable("elfLog.proxyResponse", elfContentLog);
}
...
if(context.getVariable("usn")&& context.getVariable("usn")!=="")
logMessage+='"usn":"'+ context.getVariable("usn")+'",';
...
logMessage+='"responseStatusCode":"'+ context.getVariable("response.status.code")+'",';
