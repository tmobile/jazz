...
/*if(typeof elfRequest !== 'undefined' && elfRequest !== null && elfRequest.length > 0)
{
  if (IsJsonString(elfRequest)){
        context.setVariable("test", "elfLog.proxyRequest");
...
logMessage+='"reasonPharse":"'+ context.getVariable("error.reason.pharse")+'",';
...
logMessage+='"TargetFaultResponse":'+ JSON.stringify(context.getVariable("elfLog.TargetFaultResponse"))+',';
