...
describe('Overview', () => {
  ...
  it('Create first account east region Service', function () {
    browser.driver.sleep(Common.miniWait);
  ...
  it('Verify first account east region Service and Navigation', () => {
  ...
  it('Verify METRICS Navigation for first account east region', () => {
  ...
  it('Verify first account east region Deployments', () => {
    commonUtils.verifyDelpoyment();
  });

  it('Verify first account east region Asset', () => {
    commonUtils.verifyAsset();

  });

  it('Verify first account east region Logs', () => {
    commonUtils.verifyLogs();

  });

  it('Verify METRICS COUNT for first account east region', () => {
    browser.sleep(Common.miniWait);
  ...
  it('Identifying Environment and Navigation for first account east region', () => {
    browser.driver.sleep(Common.microWait);
  ...
  it('Create the Test Branch for first account east region', () => {
    browser.getAllWindowHandles().then(function (handles) {
      browser.sleep(Common.microWait);
      var min = 11;
      var max = 99;
  ...
  it('Verify METRICS Navigation for first account east region Test Branch', () => {
  ...
  it('Verify first account east region Deployments for Test Branch', () => {
    commonUtils.verifyDelpoyment();
  });

  it('Verify first account east region Asset for Test Branch', () => {
    commonUtils.verifyAsset();
  });

  it('Verify first account east region Logs for Test Branch', () => {
    commonUtils.verifyLogs();
  });

  it('Verify METRICS COUNT for first account east region for Test Branch', () => {
    browser.driver.sleep(Common.microWait);
