...
describe('Overview', () => {
  ...
  it('Create second account east Service', function () {
    browser.driver.sleep(Common.miniWait);
  ...
  it('Verify second account east Service and Navigation', () => {
  ...
  it('Verify METRICS Navigation for second account east', () => {
  ...
  it('Verify second account east Deployment', () => {
    commonUtils.verifyDelpoyment();
  });

  it('Verify second account east Asset', () => {
    commonUtils.verifyAsset();

  });

  it('Verify second account east Logs', () => {
    commonUtils.verifyLogs();

  });

  it('Verify METRICS COUNT for second account east', () => {
    browser.sleep(Common.miniWait);
  ...
  it('Identifying Environment and Navigation for second account east', () => {
    browser.driver.sleep(Common.microWait);
  ...
  it('Create the Test Branch for second account east', () => {
    browser.getAllWindowHandles().then(function (handles) {
      browser.sleep(Common.microWait);
      var min = 11;
      var max = 99;
  ...
  it('Verify METRICS Navigation for second account east Test Branch', () => {
  ...
  it('Verify second account east Deployments for Test Branch', () => {
    commonUtils.verifyDelpoyment();
  });

  it('Verify second account east Asset for Test Branch', () => {
    commonUtils.verifyAsset();
  });

  it('Verify second account east Logs for Test Branch', () => {
    commonUtils.verifyLogs();
  });

  it('Verify METRICS COUNT for second account east for Test Branch', () => {
    browser.driver.sleep(Common.microWait);
