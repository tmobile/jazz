...
export class Jazz {
 ...
 getFunction() {
  ...
  getEventScheduleFixedRate() {
      ...
      //return element(by.xpath('//div[@class="radio-container"]/label[@for="fixedRate"]/span[@class="background"]'));
      return element(by.xpath('//div[@class="radio-container"]/label[@for="fixedRate"]'));
      //return element(by.xpath('/html/body/app-root/div/services/div/div[2]/div/services-list/sidebar/div/div[2]/create-service/div/div/form/section[9]/div/div[2]/div[1]/section[2]/div/label'));
   }

   getAwsEventsNone() {

      //return element(by.xpath('//div[@class="radio-container"]/label[@for="awsEventsNone"]/span[@class="background"]'));
