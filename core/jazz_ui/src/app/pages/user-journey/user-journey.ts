...
export const UserJourney = [
  ...
  },
  {
    ...
    src: environment.urls["content_base"] + "/jazz_ui/user-journey/jazz-registration.mp4?raw=true"
  },
  {
    ...
    src: environment.urls["content_base"] + "/jazz_ui/user-journey/jazz-login.mp4?raw=true"
  },
  {
    ...
    src: environment.urls["content_base"] + "/jazz_ui/user-journey/jazz-create-service.mp4?raw=true"
  },
  {
    ...
    src: environment.urls["content_base"] + "/jazz_ui/user-journey/jazz-configure-service.mp4?raw=true",
  },
  {
    ...
    src: environment.urls["content_base"] + "/jazz_ui/user-journey/jazz-go-to-service.mp4?raw=true",
  },
  {
    message: "This link will take you to you service's Git repository.",
    src: environment.urls["content_base"] + "/jazz_ui/user-journey/jazz-service-details.mp4?raw=true"
  },
  {
    ...
    src: environment.urls["content_base"] + "/jazz_ui/user-journey/jazz-bitbucket-environment.mp4?raw=true",
    class: "modal-overlay",
  ...
  },
  {
    ...
    src: environment.urls["content_base"] + "/jazz_ui/user-journey/jazz-go-to-environment.mp4?raw=true",
  ...
  },
  {
    ...
    src: environment.urls["content_base"] + "/jazz_ui/user-journey/jazz-test-api.mp4?raw=true"
  },
  {
