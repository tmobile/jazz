  ...
  async.series(
    {
      ...
      validateNotEditableFieldsInUpdate: function(onComplete) {
        ...
        validateUtils.validateNotEditableFieldsInUpdate(
          service_data,
          non_editable_fields_for_update,
          onComplete
        )
      },
      ...
      validateEditableFieldsValue: function(onComplete) {
        ...
        validateUtils.validateEditableFieldsValue(
          service_data,
          empty_allowed_fields_for_update,
          onComplete
        )
      },
      ...
      validateStatusStateChange: function(onComplete) {
        ...
        validateUtils.validateStatusStateChange(
          service_data,
