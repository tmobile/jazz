  ...
  async.series(
    {
      ...
      validateAllRequiredFields: function(onComplete) {
        ...
        validateUtils.validateAllRequiredFields(
          service_data,
      ...
      validateUnAllowedFieldsInInput: function(onComplete) {
        ...
        validateUtils.validateUnAllowedFieldsInInput(
          service_data,
          service_field_list,
          onComplete
        )
      ...
      validateAllRequiredFieldsValue: function(onComplete) {
        ...
        validateUtils.validateAllRequiredFieldsValue(
          service_data,
          required_fields_create,
          onComplete
        )
      ...
      validateServiceTypeAndRuntimeRelation: function(onComplete) {
        ...
        validateUtils.validateServiceTypeAndRuntimeRelation(
          service_data,
          onComplete
        )
      },
      ...
      validateServiceExists: function(onComplete) {
        getAllRecords = 'true'
        var query = {
          service: service_data.service.toLowerCase(),
          domain: service_data.domain.toLowerCase(),
        }
        crud.getList(query, getAllRecords, function onServiceGet(error, data) {
          if (error) {
            ...
            if (data.services.length > 0) {
              logger.error(
                'Service name in the specified domain already exists.'
              )
