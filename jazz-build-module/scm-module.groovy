...
def getRepoUrl(repo_name) {
    if (scm_config.SCM.TYPE == "gitlab") {
        ...
        return "${scm_protocol}${scm_config.REPOSITORY.BASE_URL}/projects/${scm_config.REPOSITORY.REPO_BASE_SERVICES}/repos/${repo_name}";
    }
}
...
def getCoreRepoUrl(repo_name) {
    if (scm_config.SCM.TYPE == "gitlab") {
        ...
        return "${scm_protocol}${scm_config.REPOSITORY.BASE_URL}/projects/${scm_config.REPOSITORY.REPO_BASE_PLATFORM}/repos/${repo_name}";
    }
}
