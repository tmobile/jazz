...
export const UserJourney = [
  ...
  },
  {
    ...
    src: environment.urls["content_base"] + "/jazz-ui/user-journey/jazz-registration.mp4"
  },
  {
    ...
    src: environment.urls["content_base"] + "/jazz-ui/user-journey/jazz-login.mp4"
  },
  {
    ...
    src: environment.urls["content_base"] + "/jazz-ui/user-journey/jazz-create-service.mp4"
  },
  {
    ...
    src: environment.urls["content_base"] + "/jazz-ui/user-journey/jazz-configure-service.mp4",
  },
  {
    ...
    src: environment.urls["content_base"] + "/jazz-ui/user-journey/jazz-go-to-service.mp4",
  },
  {
    message: "This link will take you to the repository in Bitbucket.",
    src: environment.urls["content_base"] + "/jazz-ui/user-journey/jazz-service-details.mp4"
  },
  {
    ...
    src: environment.urls["content_base"] + "/jazz-ui/user-journey/jazz-bitbucket-environment.mp4",
    class: "modal-overlay",
  ...
  },
  {
    ...
    src: environment.urls["content_base"] + "/jazz-ui/user-journey/jazz-go-to-environment.mp4",
  ...
  },
  {
    ...
    src: environment.urls["content_base"] + "/jazz-ui/user-journey/jazz-test-api.mp4"
  },
  {
